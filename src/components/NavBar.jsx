...
//List de diferentes links que tendremos
// cada vez que tengamos una seccion, esta sera encapsulada por un div con un id con el nombre de la seccion
        ...
        <div className="container flex items-center justify-between">
            <a className="text-xl font-bold text-primary flex items-center" 
                ...
                <span className="relative z-10">
                    <span className="text-glow text-foreground">Francisco Menendez</span>{" "}
                    Curriculum
                </span>    
            </a> 
